...
import com.paipianwang.pat.common.domain.SessionInfo;
import com.paipianwang.pat.common.entity.Right;
...
public class ValidateUtil {
	...
	public static boolean hasRight(final String uri, final HttpServletRequest req, final ServletContext sc,
			final Right right, final HttpServletResponse resp, final SessionInfo info) {
